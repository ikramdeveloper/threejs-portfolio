...
export const IslandModel = ({
  ...
  useFrame(() => {
    ...
    if (!isRotating) {
      ...
      switch (true) {
        case normalizedRotation >= 5.15 && normalizedRotation <= 5.95:
          setCurrentStage(4);
          break;
        case normalizedRotation >= 0.85 && normalizedRotation <= 1.95:
          setCurrentStage(3);
          break;
        case normalizedRotation >= 2.15 && normalizedRotation <= 3.25:
          setCurrentStage(2);
          break;
        case normalizedRotation >= 3.55 && normalizedRotation <= 4.85:
          setCurrentStage(1);
          break;
        default:
          setCurrentStage(0);
